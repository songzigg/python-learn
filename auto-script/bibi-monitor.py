...
class BilibiliUPMonitor():
    def __init__(self, username='三川纵横', up_ids=['352032267'], time_interval=1800, server_key=None):
        self.up_ids = up_ids
    ...
    def login(self):
        ...
        infos_return, session = bili.login(self.username, '老辣椒man', 'scanqr')
        return infos_return, session


if __name__ == '__main__':
    runpy = BilibiliUPMonitor()
    runpy.run()