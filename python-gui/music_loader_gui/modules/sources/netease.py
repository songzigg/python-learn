...
class Netease(Base):
    def __init__(self, config, logger_handle, **kwargs):
        # super(Netease, self).__init__(config, logger_handle, **kwargs) 这行代码的意思是，
        # 调用 Base 类的 __init__ 方法来初始化一个 Netease 类的对象。这样做的好处是，你可以在 Netease 类中添加额外的初始化逻辑，
        # 同时保留 Base 类的初始化逻辑。
    ...
    def search(self, keyword, disable_print=True):
        ...
        quality = cfg.get('music_quality', 0)
    ...
    def __initialize(self):
        ...
        self.search_url = 'http://music.163.com/weapi/search/get?csrf_token='
