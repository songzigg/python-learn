...
class kugou_api:
    def __init__(self):
        self.audio_id = ''
    def MD5_sign(self,timestamp, audio_id):
        """
    ...
    def MD5_sign_search(self,timestamp, music_name):
        """
    ...
    def search_url(self,music_name):
        """
...
if __name__ == '__main__':
    kugou_api = kugou_api()
    kugou_api.directory_create()  # 判断music_flie文件是否存在

    music_name = '听说你'
    audio_id = kugou_api.search_url(music_name)  # (苏星婕 - 把回忆拼好给你, 72jrv7fa)
    print(audio_id)
    ...
    print(emixsong_id)
    time.sleep(2)
    url_mp3 = kugou_api.fetch_url(emixsong_id)  # 获取 ......mp3
    print(url_mp3)
